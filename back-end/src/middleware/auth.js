/* 
    ...
    se um token de autenticação foi enviado junto com a request
*/
...
for(let route of bypassRoutes) {
    ...
    /* 
        O cabeçalho de autorização tem o formato "Bearer XXXXXX",
        onde XXXXXX é o token. Portanto, precisamos dividir esse
        cabeçalho em duas partes, cortando-o onde est´o caracter de espaço,
        e aproveitar apenas a segunda parte;
    */
