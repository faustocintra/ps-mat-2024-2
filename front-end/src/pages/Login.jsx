...
export default function Login() {
    ...
    const { authUser, setAuthUser, redirectLocation, setRedirectLocation } = React.useContext(AuthUserContext)
    ...
    function handleClick(event) {
        /* Alterna avisibilidade da senha */
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            // Se o valor da variável email não contiver @, será tratado como um suername
